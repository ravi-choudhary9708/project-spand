...
QuantumShield is a next-generation security intelligence platform designed for the Post-Quantum (PQ) transition. 
It automates the discovery of cryptographic vulnerabilities, calculates Harvest-Now-Decrypt-Later (HNDL) risk, and generates CycloneDX CBOM reports 
for global and regional compliance.
